...
module.exports = {
    ...
    run: async function(client, message, args){
        ...
        .setColor("#FF0000")
				...
				.addField("<a:Music:841963243676106752> __**Music Commands**__", "`play`, `skip`, `join`, `leave`, `volume`, `queue`, `np`, `stop`, `loop`, `pause`, `resume`, `lyrics`, `playlist`, `remove`, `shuffle`, `skipto`, `search`, `setvc`", false)
